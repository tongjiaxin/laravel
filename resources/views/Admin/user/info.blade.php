...
@section("content")
    <div class="pageheader">
        <h2><i class="fa fa-edit"></i> 修改用户信息 <span>Subtitle goes here...</span></h2>
    ...
    <div class="contentpanel">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body panel-body-nopadding">
                @foreach($users as $v)
                <form class="form-horizontal form-bordered" method="post" action="/AdminUser/info1" enctype="multipart/form-data">
                    {{csrf_field()}}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="id" placeholder="请输入用户ID" class="form-control" value="{{$v->id}}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="disabledinput">用户名</label>
                        <div class="col-sm-6">
                            <input type="text" name="username" value="{{$v->username}}" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="password" value="{{$v->password}}" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            @if($v->is_super==1)
                            <div class="radio"><label><input type="radio" name="is_super" value="1" checked="">是</label></div>
                                <div class="radio"><label><input type="radio" name="is_super" value="0">否</label></div>
                            @elseif($v->is_super==0)
                                <div class="radio"><label><input type="radio" name="is_super" value="1">是</label></div>
                                <div class="radio"><label><input type="radio" name="is_super" value="0" checked="">否</label></div> @endif
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            @else
                                <div class="radio"><label><input type="radio" name="status" value="1" checked="">正常</label></div>
                            <div class="radio"><label><input type="radio" name="status" value="2"  checked="">注销</label></div>
                                @endif
                        </div>
                    </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-sm-6 col-sm-offset-3">
                                <input type="submit" value="修改用户信息" class="btn btn-primary btn-danger"/>&nbsp;
                            </div>
                        </div>
                    </div>
                </form>
