...
@section("content")
    <div class="pageheader">
        <h2><i class="fa fa-edit"></i> 添加类型 <span>Subtitle goes here...</span></h2>
    ...
    <div class="contentpanel">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">类型</h4>
            </div>
            <div class="panel-body panel-body-nopadding">

                <form class="form-horizontal form-bordered" method="post" action="/Leader/add22">
                    {{csrf_field()}}
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="disabledinput">类型</label>
                        <div class="col-sm-6">
                            <input type="text" name="type_name" placeholder="请输入类型" class="form-control" />
                        </div>
                    </div>
